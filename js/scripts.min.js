...
$(function(){function e(){$(".carousel_services_item").each(function(){var e=$(this),s=e.find(".carousel_services_content").outerHeight();e.find(".carousel_services_image").css("min-height",s)})}$("#my_menu").mmenu({extensions:["theme-black","fx-menu-slide","pagedim-black"],navbar:{title:'<img src="img/logo.svg" alt="Салон красоты Смитлер">'},offCanvas:{position:"right"}});var s=$("#my_menu").data("mmenu");s.bind("open:finish",function(){$(".hamburger").addClass("is-active")}),s.bind("close:finish",function(){$(".hamburger").removeClass("is-active")}),$(".carousel_services").on("initialized.owl.carousel",function(){setTimeout(function(){e()},100)}),$(".carousel_services").owlCarousel({loop:!0,nav:!0,smartSpeed:700,dots:!1,navText:['<i class="fa fa-angle-double-left"></i>','<i class="fa fa-angle-double-right"></i>'],responsiveClass:!0,responsive:{0:{items:1},769:{items:2},993:{items:3}}}),e(),$(".carousel_services_composition h3").each(function(){var e=$(this);e.html(e.html().replace(/(\S+)\s*$/,"<span>$1</span>"))}),$("section h2").each(function(){var e=$(this);e.html(e.html().replace(/^(\S+)/,"<span>$1</span>"))}),$("select").selectize(),$("form.callback").submit(function(){var e=$(this);return $.ajax({type:"POST",url:"mail.php",data:e.serialize()}).done(function(){$(e).find(".success").addClass("active").css("display","flex").hide().fadeIn(),setTimeout(function(){$(e).find(".success").removeClass("active").fadeOut(),e.trigger("reset")},3e3)}),!1}),$(".reviews").owlCarousel({items:1,loop:!0,smartSpeed:700,nav:!1,autoHeight:!0}),$(".partners").owlCarousel({loop:!0,items:4,smartSpeed:700,dots:!1,nav:!0,navText:['<i class="fa fa-angle-left"></i>','<i class="fa fa-angle-right"></i>'],responsiveClass:!0,responsive:{0:{items:1},600:{items:2},992:{items:3},1200:{items:4}}}),$(window).scroll(function(){$(this).scrollTop()>$(this).height()?$(".top").addClass("active"):$(".top").removeClass("active")}),$(".top").click(function(){$("html,body").stop().animate({scrollTop:0},"slow","swing")}),$(window).resize(function(){$(".carousel_services_content").equalHeights()})}),$(window).on("load",function(){$(".preloader").delay(1e3).fadeOut("slow")});